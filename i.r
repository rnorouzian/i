...
\nNorouzian, R. (in press). Sample size planning in quantitative L2 research: A pragmatic approach. \nStudies in Second Language Acquisition."
...
plan.mrm2 <- function(peta, n.rep, n.group, factor.type = c("between", "within", "bw"), sig.level = .05, n.covar = 0, power = .8, eps = .9,
                             rho = .5, d = NA){
...
sdif2 <- function(n = NULL, mpre = NULL, mpos = NULL, sdpre = NULL, sdpos = NULL, r = NULL, t = NULL, F1 = NULL,
                 sdp = NULL){
...
rdif2 <- function(n = NULL, mpre = NULL, mpos = NULL, sdpre = NULL, sdpos = NULL, t = NULL, F1 = NULL, sdif = NULL, 
                 sdp = NULL) {
...
d.prepos4 <- function(n = NULL, mpre = NULL, mpos = NULL, sdpre = NULL, sdpos = NULL, r = NULL, autoreg = FALSE, t = NULL, sdif = NULL, sdp = NULL, F1 = NULL, df2 = NULL, d.per.study = NULL, extract, study.name = NULL, group.name = NULL, post, control, ...) 
{
...
dint4 <- function(..., per.study, study.name = NULL, group.name = NULL, n.sim = 1e5, digits = 6, by = NULL)
  {
...
meta.within3 <- function(..., per.study, study.name = NULL, group.name = NULL, outcome.name = NULL, tau.prior = function(x){dhnorm(x)}, by = NULL){
...
meta.bayes3 <- function(..., per.study, group.name = NULL, study.name = NULL, outcome.name = NULL, tau.prior = function(x){dhnorm(x)}, by = NULL, long = FALSE)
{
...
meta.within <- function(..., per.study = NULL, study.name = NA, group.name = NA, outcome.name = NA, tau.prior = function(x){dhnorm(x)}, by, data = NULL){
  
  L <- eval(substitute(dint(... = ..., per.study = per.study, group.name = group.name, study.name = study.name, by = by, data = data)))
  
  outcome.name <- if(anyNA(outcome.name)) " " else paste0(outcome.name, ":")
